...
function Customers() {
  ...
  const handleDownloadXLS = () => {
    ...
    link.setAttribute(
      "download",
      `Statement_${getCustomerName(expandedCustomer)}_${generatedStatement.from}_${generatedStatement.to}.csv`,
    );
  ...
  const addComment = async () => {
    ...
    try {
      ...
      fetchActivities(expandedId); // refresh activity log after comment
    } catch (err) {
  ...
  const openingBalance = expandedCustomer
    ? parseFloat(expandedCustomer.opening_balance) || 0
    : 0;
    ...
    <div style={{ padding: "30px", maxWidth: "1200px", margin: "auto" }}>
      ...
      >
        ...
        <div style={{ display: "flex", gap: "10px" }}>
          <button onClick={() => navigate("/customers/new")} style={primaryBtn}>
            + New Customer
          </button>
              ...
              <div style={dropdownMenuStyle}>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  {columnsOpen && (
                    ...
                    >
                      {ALL_COLUMNS.filter((c) => c.key !== "checkbox").map(
                        (col) => (
                          <label
                            key={col.key}
                            style={{
      ...
      {selected.length > 0 && (
        <div style={actionBarStyle}>
          ...
          <button onClick={() => setSelected([])} style={cancelBtnStyle}>
            Cancel Selection
          </button>
        </div>
      )}
                          ...
                          >
                            <div>
                              ...
                              {!expandedCustomer.enable_portal && (
                                <button
                                  onClick={() => handleInvitePortal(c.id)}
                                  style={{
                                    ...primaryBtn,
                                    marginTop: "10px",
                                    fontSize: "13px",
                            ...
                            <div style={{ display: "flex", gap: "10px" }}>
                              ...
                              <div style={{ position: "relative" }}>
                                <button
                                  onClick={() =>
                                    setNewTransactionOpen(!newTransactionOpen)
                                  }
                                  style={{
                                    ...primaryBtn,
                                    background: "#6c757d",
                                ...
                                {newTransactionOpen && (
                                  ...
                                  >
                                    ...
                                    <button
                                      ...
                                      onClick={() => {
                                        setNewTransactionOpen(false);
                                        toast("Expense feature coming soon");
                                      }}
                                    >
                                      📉 Expense
                                    </button>
                                    <button
                                      ...
                                      onClick={() => {
                                        setNewTransactionOpen(false);
                                        toast("Project feature coming soon");
                                      }}
                                    >
                                      📂 Project
                                    </button>
                                  ...
                                  >
                                      ...
                                      onClick={async () => {
                                        ...
                                        try {
                                          ...
                                          if (res)
                                            setExpandedCustomer(res.customer);
                                          fetchCustomers();
                                          fetchActivities(c.id); // refresh activity log after status change
                                        } catch (err) {
                                          toast.error(
                                    ...
                                    <button
                                      ...
                                      onClick={() => {
                                        setMoreOpen(false);
                                        toast(
                                          "Credit note feature coming soon",
                                        );
                                      }}
                                    >
                                      New Credit Note
                              ...
                              <div>
                                ...
                                <div style={cardStyle}>
                                  {shipping ? (
                                    <>
                                      <p>
                                        <strong>{shipping.attention}</strong>
                                      </p>
                              ...
                              <div>
                                ...
                                <div style={cardStyle}>
                                  <p>
                                    ...
                                    {expandedCustomer.customer_type}
                                  </p>
                                  <p>
                                    <strong>Sub‑Type:</strong>{" "}
                                    {expandedCustomer.customer_sub_type || "—"}
                                  </p>
                                  <p>
                                    <strong>Default Currency:</strong>{" "}
                                    {expandedCustomer.currency}
                                  </p>
                                  <p>
                                    <strong>Postal Status:</strong>{" "}
                                    {expandedCustomer.enable_portal
                                      ? "Enabled"
                                      : "Disabled"}
                                  </p>
                                  <p>
                                    ...
                                    {expandedCustomer.portal_language ||
                                      expandedCustomer.language ||
                                      "English"}
                                  </p>
                                  <p>
                                    <strong>Payment Due Period:</strong>{" "}
                                    {expandedCustomer.payment_terms ||
                                      "Due on Receipt"}
                                  </p>
                                </div>
                                    ...
                                    >
                                      {incomeChartData.map((item) => (
                                        ...
                                        >
                                          <div
                                            style={{
                                              height: `${(item.amount / chartMax) * 150}px`,
                                              width: "20px",
                                              background: "#4a90e2",
                            ...
                            <div>
                              ...
                              <div style={{ marginBottom: "40px" }}>
                                ...
                                >
                                  ...
                                  <button
                                    onClick={() =>
                                      handleNewTransaction(expandedId)
                                    }
                                    style={primaryBtn}
                                  >
                                    + New Invoice
                              ...
                              <div style={{ marginBottom: "40px" }}>
                                ...
                                >
                                  ...
                                  <button
                                    onClick={() =>
                                      toast("Projects feature coming soon")
                                    }
                                    style={primaryBtn}
                                  >
                                    + New Project
                              ...
                              <div style={{ marginBottom: "40px" }}>
                                ...
                                >
                                  ...
                                  <button
                                    onClick={() =>
                                      toast("Journals feature coming soon")
                                    }
                                    style={primaryBtn}
                                  >
                                    + New Journal
                              ...
                              <div style={{ marginBottom: "40px" }}>
                                ...
                                >
                                  ...
                                  <button
                                    onClick={() =>
                                      toast("Bills feature coming soon")
                                    }
                                    style={primaryBtn}
                                  >
                                    + New Bill
                              ...
                              <div style={{ marginBottom: "40px" }}>
                                ...
                                >
                                  <h3 style={{ margin: 0 }}>Credit Notes</h3>
                                  <button
                                    onClick={() =>
                                      toast("Credit notes feature coming soon")
                                    }
                                    style={primaryBtn}
                                  >
                                    + New Credit Note
                              ...
                              <div style={{ marginBottom: "40px" }}>
                                ...
                                >
                                  No payments received or recorded yet.
                                </div>
                              </div>
                            </div>
                          )}
                            ...
                            <div>
                              ...
                              >
                                ...
                                <button
                                  onClick={() =>
                                    toast(
                                      "Link email account feature coming soon",
                                    )
                                  }
                                  style={primaryBtn}
                                >
                              ...
                              >
                                ...
                                >
                                  System emails (e.g., statements, invoice
                                  reminders) will appear here once the email
                                  account is linked.
                                </p>
                              </div>
                            </div>
                              ...
                              >
                                ...
                                >
                                  <select
                                    ...
                                    onChange={(e) => {
                                      setStatementPreset(e.target.value);
                              ...
                              {generatedStatement && (
                                ...
                                >
                                  ...
                                  <p style={{ margin: "5px 0" }}>
                                    Statement Period:{" "}
                                    <strong>{generatedStatement.from}</strong>{" "}
                                    to <strong>{generatedStatement.to}</strong>
                                  </p>
                                  <table
                                    style={{
                                      width: "100%",
                                  ...
                                  >
                                    <thead>
                                      <tr style={{ background: "#f1f5f9" }}>
                                        <th style={thStyle}>Account Summary</th>
                                        <th style={thStyle}>Amount</th>
                                      </tr>
                                    </thead>
                                    <tbody>
                                      <tr>
                                        ...
                                        <td style={tdStyle}>
                                          ₹{generatedStatement.openingBalance}
                                        </td>
                                      </tr>
                                      <tr>
                                        <td style={tdStyle}>Invoiced Amount</td>
                                        <td style={tdStyle}>
                                          ₹{generatedStatement.totalInvoiced}
                                        </td>
                                      </tr>
                                      <tr>
                                        <td style={tdStyle}>Amount Received</td>
                                        <td style={tdStyle}>
                                          ₹{generatedStatement.amountReceived}
                                        </td>
                                      </tr>
                                      <tr style={{ fontWeight: "bold" }}>
                                        <td style={tdStyle}>Balance Due</td>
                                        <td style={tdStyle}>
                                          ₹{generatedStatement.balanceDue}
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                                  ...
                                  >
                                    ...
                                    <button
                                      onClick={() =>
                                        handleSendEmail(expandedCustomer)
                                      }
                                      style={secondaryBtn}
                                    >
                                      Send Email
...
const StatBox = ({ label, value, highlight }) => (
  <div
    style={{
      background: highlight ? "#e8f4fd" : "#f9fafb",
      borderRadius: "8px",
      padding: "15px 25px",
      minWidth: "120px",
      textAlign: "center",
