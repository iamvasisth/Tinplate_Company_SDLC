    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="/invoices/:id/document" element={<ProtectedRoute module={MODULES.INVOICES}><InvoiceDetail /></ProtectedRoute>} />
          ...
          <Route path="/projected-payments" element={<ProtectedRoute module={MODULES.BANKING}><ProjectedPayment /></ProtectedRoute>} />
          ...
          <Route path="/bank-accounts" element={<ProjectedPayment />} />
