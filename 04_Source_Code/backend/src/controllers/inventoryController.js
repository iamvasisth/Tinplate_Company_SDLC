  ...
  try {
    ...
    const moveRes = await client.query(
      `INSERT INTO inventory_movements 
       (user_id, item_id, movement_type, quantity, previous_stock, new_stock, reason, reference_number, notes)
       VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING *`,
      [req.user.id, item_id, movement_type, movQty, currentStock, newStock, reason, reference_number, notes]
    );
