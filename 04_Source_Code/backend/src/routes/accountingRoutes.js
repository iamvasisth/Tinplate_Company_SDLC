...
const { getAccounts, getAccountById, createAccount, updateAccount, deleteAccount, getJournals, getJournalById, createJournal, updateJournal, deleteJournal, getProjectedPayments } = require("../controllers/accountingController");
